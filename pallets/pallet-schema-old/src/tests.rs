...
const LONG_DESC : &str = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec aliquam ut tortor nec congue. Pellente";
...
fn create_product_without_props() {
    new_test_ext().execute_with(|| {
        ...
        let result = SchemaRegistry::register_product(
